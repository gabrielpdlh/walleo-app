...
Esta base usa Next.js 16. Antes de alterar APIs, convencoes ou estrutura do framework, consulte a documentacao relevante em `node_modules/next/dist/docs/` e valide avisos de deprecacao.
