...
const productRows = [
  ...
  { id: "prd_espetinho_carne", merchantId: "mer_palco_sunset", name: "Espetinho de Carne", priceCents: 1200, imageUrl: "/products/espetinho-carne-certo.jpg" },
  { id: "prd_espetinho_frango", merchantId: "mer_palco_sunset", name: "Espetinho de Frango", priceCents: 1000, imageUrl: "/products/espetinho-frango-certo.webp" },
  { id: "prd_hamburguer", merchantId: "mer_palco_sunset", name: "Hambúrguer Artesanal", priceCents: 2800, imageUrl: "/products/hamburguer-certo.jpg" },
  { id: "prd_cachorro_quente", merchantId: "mer_palco_sunset", name: "Cachorro-quente", priceCents: 1800, imageUrl: "/products/cachorro-quente-certo.jpg" },
  { id: "prd_batata_frita", merchantId: "mer_palco_sunset", name: "Batata Frita", priceCents: 2000, imageUrl: "/products/batata-frita-certo.webp" },
  { id: "prd_pastel", merchantId: "mer_palco_sunset", name: "Pastel", priceCents: 1500, imageUrl: "/products/pastel-certo.jpg" },
  { id: "prd_cerveja_long", merchantId: "mer_palco_sunset", name: "Cerveja Long Neck", priceCents: 1200, imageUrl: "/products/cerveja-certo.webp" },
  { id: "prd_chopp", merchantId: "mer_palco_sunset", name: "Chopp", priceCents: 1000, imageUrl: "/products/chopp-certo.jpeg" },
  { id: "prd_gin_tonica", merchantId: "mer_palco_sunset", name: "Gin Tônica", priceCents: 2500, imageUrl: "/products/gin-tonica-certo.jpg" },
  { id: "prd_caipirinha", merchantId: "mer_palco_sunset", name: "Caipirinha", priceCents: 2200, imageUrl: "/products/capirinha-certo.webp" },
  { id: "prd_refrigerante_ps", merchantId: "mer_palco_sunset", name: "Refrigerante", priceCents: 800, imageUrl: "/products/refrigerante-certo.webp" },
  { id: "prd_agua_ps", merchantId: "mer_palco_sunset", name: "Água Mineral", priceCents: 500, imageUrl: "/products/agua-certo.jpg" },
  // Loja Oficial
